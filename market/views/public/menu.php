			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu form">
					<?php echo form_open('#'); ?>
						...
						<input class="btn btn-info" type="submit" id="register" value="<?php echo lang('reg.submit'); ?>">
					</form>
				</ul>
			</li>
			<li class="dropdown">
				...
				<ul class="dropdown-menu form">
					<?php echo form_open('#'); ?>
						...
						<input class="btn btn-info" type="submit" id="login" value="<?php echo lang('login.submit'); ?>">
					</form>
				</ul>
			</li>
		</ul>
