...
|
*/
$config['base_url']	= 'http://www.example.com/bitmarket/';
...
|
*/
$config['encryption_key'] = 'gqlR4wRp4r3j03KO7utYn7veh1BG3NYi';
...
$config['sess_cookie_name']		= 'bm_session';
$config['sess_expiration']		= 7200; // 2*60*60
...
$config['sess_time_to_update']	= 900; //15*60
...
$config['csrf_token_name'] = 'bm_csrf_token';
...
/* Location: ./market/config/development/config.php */